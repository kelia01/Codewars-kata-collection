...
// After his first successful year of business, Ronald decides to buy 3 more chickens 
// at the start of each year.

// Your Task:
// For a given year, and life span of chicken span, calculate how many eggs Ronald's chickens 
// will lay him that year, whereby year=1 is when Ronald first got his inheritance and span>0.
// If year=0, make sure to return "No chickens yet!".

// Note:
// 1. All chickens have the same life span regardless of when they are bought.
// 2. Let's assume all calculations are made at the end of the year so don't bother taking 
// eggs laid per month into consideration.
// 3. Each chicken's egg production goes down by 20% each year, NOT the total number of 
